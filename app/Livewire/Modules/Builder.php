...
class Builder extends Component
{
    ...
    public function generate(ModuleGenerator $generator): void
    {
        ...
        $sanitizedFields = collect($validated['fields'])
            ->map(fn (array $field) => [...$field, 'name' => ModuleNameGuard::fieldName($field['name'] ?: $field['label'])])
            ->values()
            ->all();
    ...
    protected function validatePayload(): array
    {
        return $this->validate([
            ...
            'tableName' => ['nullable', 'string', 'max:63'],
            ...
            'fields.*.name' => ['nullable', 'string', 'max:63'],
